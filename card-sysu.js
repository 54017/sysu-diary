		...
		getValidateCode: function(resolve, reject) {
			...
			let req = http.get(options, function(res) {
				...
				res.on('error', function(e) {
					console.log('error in get validateCode card: ', e);
				});
				resolve();
			}.bind(this)).on('error', function(e) {
				console.log('error in get validateCode req card: ', e);
			});
		},
		...
		login: function(resolve, reject) {
			...
			let req = http.request(options, function(res) {
				if (res.statusCode === 200) {
					...
					res.on('error', function(e) {
						console.log('error in login card: ', e);
					})
					resolve();
				}
			}.bind(this)).on('error', function(e) {
				console.log('error in login req card:', e);
			});
			req.write(postData);
			req.end();
		},
